...
/* USER CODE BEGIN PV */
TrafficLightMode curentMode = LIGHT_TRAFFIC_MODE;
/* USER CODE END PV */
...
void updateState(void)
{
    if (isButtonPressed(GPIOA, GPIO_PIN_0))
    {
        switchToLightTrafficMode();
    }
    else if (isButtonPressed(GPIOA, GPIO_PIN_1))
    {
        switchToHeavyTrafficMode();
    }
    else if (isButtonPressed(GPIOA, GPIO_PIN_2))
    {
        switchToNightMode();
    }
    else if (isButtonPressed(GPIOA, GPIO_PIN_3))
    {
        switchToControlMode();
    }
}
...
void switchToLightTrafficMode(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_SET);    // Bật LED cho LIGHT_TRAFFIC_MODE (PB0)
...
void switchToHeavyTrafficMode(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_1, GPIO_PIN_SET);    // Bật LED cho HEAVY_TRAFFIC_MODE (PB1)
...
void switchToControlMode(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2, GPIO_PIN_SET);    // Bật LED cho CONTROL_MODE (PB2)
...
void switchToNightMode(void)
{
    ...
    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_SET);    // Bật LED cho NIGHT_MODE (PB3)
